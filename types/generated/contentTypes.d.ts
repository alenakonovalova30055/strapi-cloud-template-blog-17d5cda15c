...
export interface ApiApartmentApartment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    rooms: Schema.Attribute.BigInteger;
...
export interface ApiAttractionAttraction extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    antive: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText;
...
export interface ApiInfrastructureItemInfrastructureItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'infrastructure_items';
  info: {
    displayName: 'InfrastructureItem';
    pluralName: 'infrastructure-items';
    singularName: 'infrastructure-item';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::infrastructure-item.infrastructure-item'
    > &
      Schema.Attribute.Private;
    order: Schema.Attribute.BigInteger;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    showInBooking: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSingleTypeSingleType extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::infrastructure-item.infrastructure-item': ApiInfrastructureItemInfrastructureItem;
